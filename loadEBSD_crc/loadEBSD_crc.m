...
% Replaces MTEX's default "loadEBSD_crc.m" file located in the
% "~\mtex\interfaces" folder to include the automatic loading of energy
% dispersive x-ray spectroscopy (EDS) elemental data stored within a *.crc
% and *.cpr file when combined EBSD+EDS mapping is undertaken.
% The EDS elemental data comprises total counts per pixel without any peak
% deconvolution and background removal undertaken.
...
%
%% Input:
%  fname      - @string of the path and file name
%
%% Output:
%  ebsd       - @EBSD
%
