...
## C
- [**calcFFT**](https://github.com/AzdiarGazder/mtexTools/tree/main/calcFFT): Returns the Fast Fourier Transforms (FFTs) of individual grains. The real and complex FFTs are returned in grid format within the 'grains.prop.fftReal' and 'grains.prop.fftComplex' structure variables.
