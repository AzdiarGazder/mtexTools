...
- ![Static Badge](https://img.shields.io/badge/F-FF0000) [**calcThreshold_cdf**](https://github.com/AzdiarGazder/mtexTools/tree/main/calcThreshold_cdf): Calculates a threshold based on the cumulative distribution function (CDF) of a given dataset. The bin widths of the CDF are calculated using either Scott's, Freedman-Diaconis', or  the square root rules, or by specifying a value. The threshold is determined by a specified number of standard deviations from the mean of the data.

- ![Static Badge](https://img.shields.io/badge/F-FF0000) [**calcThreshold_dcdf**](https://github.com/AzdiarGazder/mtexTools/tree/main/calcThreshold_dcdf): Calculates a threshold based on the differential of the cumulative distribution function (CDF) of a given dataset. The bin widths of the CDF are calculated using either Scott's, Freedman-Diaconis', or the square root rules, or by specifying a value. The threshold is determined by fitting a Gaussian to the differential data and finding the specified number of standard deviations from the mid-point of the fitted Gaussian.
