...
- [**calcODFIntensity**](https://github.com/AzdiarGazder/mtexTools/tree/main/calcODFIntensity): Returns a 3D variable of the ODF intensity (_f_(g)) in user-defined steps of phi2 using Bunge's notation.
