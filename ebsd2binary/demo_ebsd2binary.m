...
ebsdGrain = gridify(ebsd(grains(grainId)));
% binarise the grain of interest
binaryMap1 = ebsd2binary(ebsdGrain,'ones');
binaryMap2 = ebsd2binary(ebsdGrain,'zeros');

% plot the binary maps of the grain of interest
figure; 
imagesc(binaryMap1)
figure; 
imagesc(binaryMap2)
