...
%   hatchFill(A) fills the patch(es) with handle(s) A. A can be a vector
...
%
%   hatchFill(A,STYL) applies STYL pattern with default paramters. STYL
%   options are:
...
%
%   H = hatchFill(...) returns handles to the line objects comprising the
%   hatch/speckle.
%
%   Examples:
%       Gray region with hatching:
%       hh = hatchFill(a,'cross','HatchAngle',45,'HatchSpacing',5,'FaceColor',[0.5 0.5 0.5]);
%
%       Speckled region:
%       hatchFill(a,'speckle','HatchAngle',7,'HatchSpacing',1);
